NOTES: 
Addition does not follow two's complement. Uses sign and magnitude.

Add precision...
32 (15 bits for fraction) bit has 10,000th precision
16 (7 bits for fraction) bit has 10th precision... 

Mult precision
32 915 bits for fraction) Worse case has tenth precision ( +- 0.01) Mostly hundredth precision
